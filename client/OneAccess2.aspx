...
<head>
    ...
    <link href="https://cdn.rawgit.com/docmbg/SPOneAccess2/production/css/materialdesignicons.css" media="all" rel="stylesheet" type="text/css" />
            ...
            <div id="instr-container" class="row">
                ...
                <div class="row center matrix-instr hidden" hidden>
                 ...
                 <div class="row center all-users-instr hidden" hidden>
                    ...
                    <div class="row">
                        <div class="col s12 m12 l12 center">
                            1. This will generate & download an excel file with two sheets - 'Users' & 'PDLs'. 'Users' will NOT contain the users that are in the PDLs on the SharePoint. Please double check the 'Users' list for PDLs! It should not take more than 10 seconds.
                        </div>
                    </div>
                </div>
                        ...
                        <ul id="central-nav">
                           ...
                           <li class="z-depth-1 waves-effect waves-hpe-turquoise">
                            ...
                            <li class="z-depth-1 waves-effect waves-hpe-turquoise hide-on med-and-down">
                                <a href="#" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Access Management"><img src="https://raw.githubusercontent.com/docmbg/SPOneAccess2/1.8/pics/access.png" class="material-icons image" id="show-access" /></a>
                            </li>
                            <li class="z-depth-1 waves-effect waves-hpe-orange hide-on med-and-down">
                                <a href="#" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Mass Delete"><img src="https://raw.githubusercontent.com/docmbg/SPOneAccess2/1.8/pics/trash.png" class="material-icons image" id="show-mass-delete" /></a>
                            </li>
                            <li class="z-depth-1 waves-effect waves-hpe-purple hide-on med-and-down" >
                                <a href="#" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Permission Matrix"><img src="https://raw.githubusercontent.com/docmbg/SPOneAccess2/1.8/pics/matrix.png" class="material-icons image" id="show-matrix" /></a>
                            </li>
                            <li class="z-depth-1 waves-effect waves-hpe-purple hide-on med-and-down">
                                <a href="#" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="All Users"><img src="https://raw.githubusercontent.com/docmbg/SPOneAccess2/1.8/pics/users.png" class="material-icons image"  id="show-all-users" /></a>
                            </li>
                             <li class="z-depth-1 waves-effect waves-hpe-purple hide-on med-and-down">
                                <a href="#" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="SP Structure"><img src="https://raw.githubusercontent.com/docmbg/SPOneAccess2/1.2.0/pics/distribution.png" class="material-icons image"  id="show-structure" /></a>
                            </li>
                            <li class="z-depth-1 waves-effect waves-hpe-purple hide-on med-and-down">
                                <a href="#" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Empty Folders"><img src="https://raw.githubusercontent.com/docmbg/SPOneAccess2/1.2.0/pics/empty_folders.png" class="material-icons image"  id="show-empty-folders" /></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container main-content" id="main-section">
            ...
            <div class="show-mass-delete" id="massDelete-section" hidden>
                <div class="row">
                    ...
                    <span class="col s5"><input id="file-object" type="file" value="Open an Excel file" /></span>
                </div>
                <div class = "row">
                    <div id="delete-button" class="center" hidden>
                        ...
                        </i></a></h3> <!--<button id="delete-users" >Delete Users</button>-->
                    </div>
